...
class Settings(object):  # pylint: disable=too-few-public-methods
    ...
    travis_autosave_final_commit = "[Results] Test of KADhosts"
    # Default travis commit message
    travis_autosave_commit = "[Autosave] Test of KADhosts"
    ...
    # Current directory.
    current_dir = '/home/travis/build/dead-hosts/KADhosts_git_azet12/'
